class BaseIcons extends HTMLElement {
  ...
  constructor() {
    ...
    this._icons = {
      ...
      send: `<svg width="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 12 4 4l2 8m14 0L4 20l2-8m14 0H6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
  `,
    };
  }
