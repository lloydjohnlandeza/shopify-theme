  ...
  customElements.define(
    ...
    class ProductForm extends HTMLElement {
      constructor() {
        ...
        this.headerCartDropdown = document.querySelector(
      ...
      attachedEvents() {
        this.buttons.forEach((btn) => {
          const updateQuantity = () =>
            this.updateQuantity(btn.id === "increment");
      ...
      async onSubmitHandler(evt) {
        ...
        document.querySelector("base-header-cart").item_count =
          headerDropdown.getAttribute("item_count");
